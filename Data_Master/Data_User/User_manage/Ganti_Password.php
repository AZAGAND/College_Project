...
if (!$iduser_target) die("ID user tidak ditemukan!");
...
<body>
<div class="container">
    <h2>Ganti Password User ID: <?= htmlspecialchars($iduser_target) ?></h2>

    <?php if($success): ?><p class="msg"><?= htmlspecialchars($success) ?></p><?php endif; ?>
